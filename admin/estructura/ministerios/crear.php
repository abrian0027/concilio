...
$page_title = "Nueva Área Ministerial";
...
<div class="content-header">
    <h1><i class="fas fa-plus-circle"></i> Nueva Área Ministerial</h1>
</div>

<div class="card">
    <div class="card-header">
        <span class="card-title">
            <i class="fas fa-hands-helping"></i> Crear Área para: <?php echo htmlspecialchars($iglesia['nombre']); ?>
        </span>
    </div>
    <div class="card-body">
        ...
        <form method="post" action="guardar.php">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control" required maxlength="100" 
                       placeholder="Ej: Ministerio de Parejas" style="text-transform: uppercase;">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="descripcion" class="form-control" rows="3" maxlength="500" 
                          placeholder="Descripción opcional del área ministerial"></textarea>
            </div>
